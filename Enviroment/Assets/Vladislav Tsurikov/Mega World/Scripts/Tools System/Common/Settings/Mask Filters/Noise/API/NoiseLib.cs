...
namespace VladislavTsurikov.MegaWorldSystem
{
    ...
    public static partial class NoiseLib
    {
        ...
        private static Dictionary<System.Type, INoiseShaderGenerator>      s_generators;
        // generator type => fractal type => shader
        private static Dictionary<System.Type, Dictionary<System.Type, Shader>>   s_generatedShaderMap;
        // generator type => fractal type => material
        private static Dictionary<System.Type, Dictionary<System.Type, Material>> s_generatedMaterialMap;
        ...
        public static IFractalType GetFractalTypeInstance(System.Type t)
        {
        ...
        private static bool IsSubclassOfGenericType(System.Type t, System.Type genericType)
        {
        ...
        private static IEnumerable<System.Type> GetSubclassesOfGenericType(System.Type[] types, System.Type genericType)
        {
        ...
        private static void GatherNoiseTypes()
        {
            ...
            {
                System.Type[] assemblyTypes = null;
        ...
        public static Material GetGeneratedMaterial(System.Type generatorType, System.Type fractalType)
        {
        ...
        {
            var generatorTypes = ModulesUtility.GetAllTypesDerivedFrom<INoiseShaderGenerator>()
            .Where(t => !t.IsAbstract); 

            s_generators = new Dictionary<System.Type, INoiseShaderGenerator>();
            
            foreach(System.Type t in generatorTypes)
            {
                PropertyInfo propertyInfo = t.GetProperty("instance", s_bindingFlags);
                MethodInfo methodInfo = propertyInfo.GetGetMethod();
        ...
        public static void GenerateShaders()
        {
            ...
            IFractalType[] fractalTypes = s_fractalTypes;
            INoiseType[] noiseTypes = s_noiseTypes;
            Dictionary<System.Type, INoiseShaderGenerator> generators = s_generators;

            StringBuilder shaderSB = new StringBuilder();
            StringBuilder passesSB = new StringBuilder();

            foreach(KeyValuePair<System.Type, INoiseShaderGenerator> pair in generators)
            {
                shaderSB.Clear(); 
                passesSB.Clear();
        ...
        private static void LoadShadersAndCreateMaterials()
        {
            ...
            {
                foreach(KeyValuePair<System.Type, INoiseShaderGenerator> pair in s_generators)
                {
                    foreach(IFractalType fractal in fractalTypes)
                    {
            ...
            s_generatedShaderMap = new Dictionary<System.Type, Dictionary<System.Type, Shader>>();
            s_generatedMaterialMap = new Dictionary<System.Type, Dictionary<System.Type, Material>>();

            // load related shaders
            foreach(KeyValuePair<System.Type, INoiseShaderGenerator> pair in s_generators)
            {
                s_generatedShaderMap.Add(pair.Key, new Dictionary<System.Type, Shader>());
                s_generatedMaterialMap.Add(pair.Key, new Dictionary<System.Type, Material>());
