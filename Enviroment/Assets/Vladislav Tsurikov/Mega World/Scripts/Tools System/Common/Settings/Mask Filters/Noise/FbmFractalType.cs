...
namespace VladislavTsurikov.MegaWorldSystem
{
    ...
    public class FbmFractalType : FractalType<FbmFractalType>
    {
        ...
        {
            name = "Fbm",
            templatePath = "Assets/Vladislav Tsurikov/Mega World/Scripts/Tools System/Common/Settings/Mask Filters/Shaders/NoiseLib/Templates/FractalFbm.noisehlsltemplate",
            ...
            {
                "Assets/Vladislav Tsurikov/Mega World/Scripts/Tools System/Common/Settings/Mask Filters/Shaders/NoiseLib/NoiseCommon.hlsl"
            }
        };
        ...
        {
            public static GUIContent warpEnabled = EditorGUIUtility.TrTextContent("Enabled", "Turn on/off warp");
